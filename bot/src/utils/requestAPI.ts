...
export async function makePOSTRequest(
    ...
    await fetch(`http://localhost:18103/post/${guild}/${user}`, {
        ...
        .then((data) => {
            if (!channel) return;
            if (data.sendUpdateEvent)
                handleLevelChange(guild, user, channel, data.level);
        });
}
...
export async function removeUser(guild: string, user: string) {
    const response = await fetch(
        `http://localhost:18103/post/${guild}/${user}/remove`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function setXP(guild: string, user: string, xp: number) {
    const response = await fetch(
        `http://localhost:18103/admin/set/${guild}/xp`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function setLevel(guild: string, user: string, level: number) {
    const response = await fetch(
        `http://localhost:18103/admin/set/${guild}/level`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function getRoles(guild: string) {
    const response = await fetch(
        `http://localhost:18103/admin/roles/${guild}/get`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function removeRole(
    ...
    const response = await fetch(
        `http://localhost:18103/admin/roles/${guild}/remove`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function addRole(
    ...
    const response = await fetch(
        `http://localhost:18103/admin/roles/${guild}/add`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function getUpdatesChannel(guild: string) {
    const response = await fetch(
        `http://localhost:18103/admin/updates/${guild}/get`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function setUpdatesChannel(
    ...
    const response = await fetch(
        `http://localhost:18103/admin/updates/${guild}/set`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function enableUpdates(guild: string) {
    const response = await fetch(
        `http://localhost:18103/admin/updates/${guild}/enable`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function disableUpdates(guild: string) {
    const response = await fetch(
        `http://localhost:18103/admin/updates/${guild}/disable`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function getAllGuildsWithUpdatesEnabled() {
    const response = await fetch(
        `http://localhost:18103/admin/updates/all/get`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function getCooldown(guild: string) {
    const response = await fetch(
        `http://localhost:18103/admin/cooldown/${guild}/get`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function setCooldown(guild: string, cooldown: number) {
    const response = await fetch(
        `http://localhost:18103/admin/cooldown/${guild}/set`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
...
export async function syncFromBot(guild: string, bot: string) {
    const response = await fetch(
        `http://localhost:18103/admin/sync/${guild}/${bot}`,
        {
            headers: {
                "Content-Type": "application/json",
                Authorization: process.env.AUTH as string,
