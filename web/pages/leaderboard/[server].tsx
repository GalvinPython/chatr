            ...
            fetch(`${API_URL}/get/${this.state.discordGuildId}`)
                ...
                .then((data) => {
                    ...
                    this.setState((prevState) => {
                        ...
                        const updatedData = [
                            ...prevState.chartOptions.series[0].data,
                            newDataPoint,
                        ];
                    ...
                    <div className="w-full p-6 rounded-lg flex flex-col md:flex-row justify-center items-stretch space-y-6 md:space-y-0 md:space-x-6">
                        <div className="flex flex-col w-full md:w-1/2 space-y-6 flex-1">
                            ...
                            <div className="bg-gray-900 p-4 rounded-lg flex flex-col justify-center items-center transition-transform transform hover:scale-105 flex-1">
                                ...
                                <div className="text-gray-400 mt-2 text-center text-lg">
                                    Total XP
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col w-full md:w-1/2 space-y-6 flex-1">
                            ...
                            <div className="bg-gray-900 p-4 rounded-lg flex flex-col justify-center items-center transition-transform transform hover:scale-105 flex-1">
                                <div className="text-white text-2xl sm:text-2xl md:text-3xl lg:text-3xl">
                                    <Odometer
                                        value={odometerMembersBeingTracked}
                                    />
                                </div>
                                <div className="text-gray-400 mt-2 text-center text-lg">
                                    Members Tracked
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 test">
                        {leaderboard && leaderboard.length > 0 ? (
                            leaderboard.map((user, index) => {
                                const xpNeededNextLevel =
                                    user.xp_needed_next_level;
                                const totalXpForNextLevel =
                                    user.xp + xpNeededNextLevel;
                                const progressPercentage =
                                    user.progress_next_level;

                                return (
                                    <Link
                                        key={user.id}
                                        className="bg-gray-800 p-6 rounded-lg flex flex-col space-y-4 shadow-lg hover:shadow-xl duration-300 transition-transform hover:scale-105"
                                        href={`/leaderboard/${this.state.discordGuildId}/${user.id}`}
                                    >
                            ...
                            <p className="text-gray-400 text-lg col-span-3 text-center">
